    ...
    const socialLinks = [
        {
            ...
            url: 'https://chat.whatsapp.com/DrwYlONdN7hCPb82iRkrCc?mode=ems_copy_t',
            color: '#25D366'
        },
        {
            name: 'LinkedIn',
            ...
            url: 'https://www.linkedin.com/company/gdgoc-gctc',
            color: '#0077B5'
        },
        {
            name: 'Discord',
            ...
            url: 'https://discord.com/invite/JBJbmFBSRC',
            color: '#5865F2'
        },
        {
            name: 'Instagram',
            ...
            url: 'https://www.instagram.com/gdgoc.gctc/',
            color: '#E1306C'
        },
        {
            name: 'X/Twitter',
