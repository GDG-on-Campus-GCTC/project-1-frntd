...
const Login: React.FC = () => {
  ...
  return (
    <div className="login-page">
      ...
      <div style={{ position: 'relative', zIndex: 1, padding: '60px 24px 40px', minHeight: 'calc(100vh - 120px)' }}>
        <div style={{ maxWidth: '440px', margin: '0 auto' }}>
          <div className="login-card">
          <div className="login-logo-container">
            <img src={logo} alt="GCET Study Hub" className="login-logo" />
          </div>
          
          <h1 className="login-title">Welcome Back</h1>
          <p className="login-subtitle">Sign in to continue to GCET Study Hub</p>
        ...
        <footer className="page-footer">
          <div className="footer-content">
            ...
            <div className="copyright">
              © 2025 GCET Study Hub. All rights reserved.
            </div>
          </div>
        </footer>
      </div>
